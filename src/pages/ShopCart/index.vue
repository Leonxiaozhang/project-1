  ...
  methods: {
    ...
    async togglechecked(cart, event) {
      try {
        ...
        await this.$store.dispatch("gettogglechecked", {
          skuId: cart.skuId,
          isChecked: checked,
        });
        this.$store.dispatch("getcartlist");
    ...
    async removeallchecked() {
      try {
        await this.$store.dispatch("getremoveallchecked");
        this.$store.dispatch("getcartlist");
      } catch (error) {
        alert(error.message);
      }
    },
    async allcartchecked(event) {
      try {
  ...
  computed: {
    ...
    cartzong() {
      ...
      this.cartInfoList.forEach((items) => {
        zong += items.skuNum * items.skuPrice;
      });
      return zong;
    },
    isallChecked() {
